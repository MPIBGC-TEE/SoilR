...
TwopParallelModel14<- function 
    ...
    { 
      ...
      mod=GeneralModel_14(t,At,ivList=C0,initialValF=ConstFc(F0_Delta14C,"Delta14C"),inputFluxes=inputrates,inputFc=Fc,di=lambda,pass=pass)
}
