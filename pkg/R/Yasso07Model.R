...
Yasso07Model<-structure(
    ...
    ##Leaf litter decomposition-estimates of global variability based on Yasso07 model. Ecological Modelling, 220:3362 - 3371.
     (t,      ##<< A vector containing the points in time where the solution is sought.
      ...
      p=c(p1=0.32,p2=0.01,p3=0.93,p4=0.34,p5=0,p6=0,p7=0.035,p8=0.005,p9=0.01,p10=0.0005,p11=0.03,p12=0.92,pH=0.04), ##<< A vector of length 13 containing transfer coefficients among different pools.
