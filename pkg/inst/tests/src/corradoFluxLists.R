...
internal_fluxes[["C_am->C_mic"]] = function(
  C_am
  ,N_am
  ,C_as
  ,N_as
...
internal_fluxes[["C_as->C_mic"]] = function( 
                                               C_am
                                               ,N_am
                                               ,C_as
                                               ,N_as
...
internal_fluxes[["C_fw->C_mic"]] = function( 
  C_am
  ,N_am
  ,C_as
  ,N_as
...
internal_fluxes[["C_acw->C_mic"]] = function( 
  C_am
  ,N_am
  ,C_as
  ,N_as
...
internal_fluxes[["N_am->N_mic"]] = function( 
  C_am
  ,N_am
  ,C_as
  ,N_as
...
internal_fluxes[["N_as->N_mic"]] = function( 
  C_am
  ,N_am
  ,C_as
  ,N_as
...
internal_fluxes[["N_fw->N_mic"]] = function( 
  C_am
  ,N_am
  ,C_as
  ,N_as
...
internal_fluxes[["N_acw->N_mic"]] = function( 
  C_am
  ,N_am
  ,C_as
  ,N_as
...
# InFluxCN (a data.frame):
#             times |     C_am  |     C_as  |    C_bm   |    C_bs   |    C_fw | N_am... | ... 
#               0   |     0.1   |     0.2   |    0.1    |    ...    |    ...
#               1   |     0.2   |     0.3   |    0.1    |    ...    |    ...
# InFluxes=InFluxCN[2:ncol(InFluxCN)]
# input_fluxes_time=lapply(colnames(InFluxes)),function(colname){approxfun(InFluxes[,c('times',colname)])}
# names(input_fluxes_time)<-names(InFluxes)
# Input C flux into Abovegr. Metabolic Lit
...
#               0   |     0.1   |     0.2   |    0.1    |    ...    |    ...
#               1   |     0.2   |     0.3   |    0.1    |    ...    |    ...
# Xies=XiCN[2:ncol(XiCN)]
# input_fluxes_time=lapply(colnames(Xies)),function(colname){approxfun(Xies[,c('times',colname)])}
# names(input_fluxes_time)<-names(Xies)


# Input C flux into Abovegr. Metabolic Lit

#input_fluxes_time[["C_am"]] = function(C_am, N_as,t) { Xies[['C_am']](t)*C_am/N_as**2}
#input_fluxes_time[["N_am"]] = function( N_as,t) { Xies[['N_am']](t)*C_am/N_as**2}
#}
