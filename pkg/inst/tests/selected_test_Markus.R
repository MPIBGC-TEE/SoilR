...
alltests <- defineTestSuite(
   name="allTests",
   #dirs=c("."),
   dirs=c(".","protected","automatic","TimeMap",'automaticR/'),
   #dirs=c("automatic"),
   #testFileRegexp = "^runit.NonlinearAtmosphericModel.R",
   #testFileRegexp = "^runit.BoundFc.R",
   #testFileRegexp = "^runit.TimeMap_non_scalar_lag.R",
   testFileRegexp = "^runit.BoundFcTests.R",
   #testFileRegexp = "^runit.TimeMapTests.R",
